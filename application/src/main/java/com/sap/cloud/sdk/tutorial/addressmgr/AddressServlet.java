...
import com.sap.cloud.sdk.tutorial.addressmgr.commands.CreateAddressCommand;
import com.sap.cloud.sdk.tutorial.addressmgr.commands.DeleteAddressCommand;
import com.sap.cloud.sdk.tutorial.addressmgr.commands.UpdateAddressCommand;
import com.sap.cloud.sdk.tutorial.addressmgr.util.HttpServlet;
...
public class AddressServlet extends HttpServlet {
    ...
    protected void doPost(final HttpServletRequest request, final HttpServletResponse response)
        ...
        try {
            final BusinessPartnerAddress addressCreated = new CreateAddressCommand(destination, address).execute();
    ...
    protected void doPatch(final HttpServletRequest request, final HttpServletResponse response)
        ...
        try {
            new UpdateAddressCommand(destination, addressToUpdate).execute();
    ...
    protected void doDelete(final HttpServletRequest request, final HttpServletResponse response)
        ...
        try {
            new DeleteAddressCommand(destination, businessPartnerId, addressId).execute();
